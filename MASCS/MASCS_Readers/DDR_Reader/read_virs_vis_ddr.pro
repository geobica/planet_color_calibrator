function read_virs_vis_ddr, theUnit
...
readu, theUnit, tempf512
thedata.IOF_SPECTRUM_DATA = tempf512

readu, theUnit, tempf512
thedata.PHOTOM_IOF_SPECTRUM_DATA = tempf512

readu, theUnit, tempf512
thedata.IOF_NOISE_SPECTRUM_DATA = tempf512

readu, theUnit, tempf512
thedata.PHOTOM_IOF_NOISE_SPECTRUM_DATA = tempf512

readu, theUnit, tempf
thedata.SOFTWARE_VERSION = tempf

readu, theUnit, tempf512
thedata.CHANNEL_WAVELENGTHS = tempf512
