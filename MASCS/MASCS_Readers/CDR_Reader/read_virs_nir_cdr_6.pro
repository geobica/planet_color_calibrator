...
readu, theUnit, temp256
thedata.RAW_SPECTRUM_DATA = temp256

readu, theUnit, tempb17
thedata.SPECTRUM_UTC_TIME = tempb17

readu, theUnit, temp256f
thedata.CORRECTED_COUNTS_SPECTRUM_DATA = temp256f

readu, theUnit, temp256f
thedata.CALIBRATED_RADIANCE_SPECTRUM_DATA = temp256f

readu, theUnit, temp256f
thedata.NOISE_SPECTRUM_DATA = temp256f

readu, theUnit, tempf
thedata.CALIBRATION_SOFTWARE_VERSION = tempf

readu, theUnit, temp256f
thedata.CHANNEL_WAVELENGTHS = temp256f
